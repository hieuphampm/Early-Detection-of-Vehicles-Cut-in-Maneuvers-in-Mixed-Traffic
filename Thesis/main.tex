...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{YOLO26n}: là một mô hình đầu cuối tích hợp được thiết kế cho các thiết bị biên có công suất thấp, đơn giản hóa bằng cách loại bỏ lớp hậu xử lý NMS và tối ưu MuSGD giúp ổn định và hội tụ nhanh hơn. \cite{yolo26_ultralytics}
	\end{itemize}
