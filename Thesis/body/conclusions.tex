\chapter{KẾT LUẬN \& HƯỚNG PHÁT TRIỂN}
	...
	\begin{itemize}
		...
		\item \textbf{Thiếu hụt dữ liệu trong điều kiện môi trường khắc nghiệt:} Mặc dù mô hình đã được thử nghiệm trên các kịch bản giao thông đa dạng, tập dữ liệu huấn luyện hiện tại vẫn chưa bao quát đầy đủ các tình huống thời tiết cực đoan như mưa lớn, sương mù dày đặc, hoặc điều kiện ánh sáng yếu (ban đêm/ngược sáng). Trong các điều kiện này, chất lượng ảnh đầu vào bị suy giảm nghiêm trọng do nhiễu hạt và độ tương phản thấp. Điều này làm giảm đáng kể khả năng phân tách đối tượng của YOLO, dẫn đến hiện tượng rung lắc khung bao hoặc mất dấu đối tượng tạm thời. Khi các nhiễu loạn này được truyền vào mô hình LSTM, chúng làm sai lệch chuỗi đặc trưng thời gian, gây ra hiện tượng tích lũy sai số và dẫn đến các cảnh báo sai (false alarms) hoặc bỏ lỡ các hành vi tạt đầu thực tế do mất tín hiệu ổn định.
	\end{itemize}
