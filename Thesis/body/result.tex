...
% =========================================================
\section{Kết quả huấn luyện mô hình nhận thức không gian (YOLO26n)}
...
% =========================================================
\section{Đánh giá thực nghiệm hệ thống lai (YOLO + LSTM + Zones)}
...
\subsection{Kịch bản 1: Môi trường bình thường (Lane Keeping)}
...
\subsection{Kịch bản 2: Cảnh báo sớm ý định (Early Warning)}
...
\subsection{Kịch bản 3: Xâm nhập vùng nguy hiểm (Cut-in Danger)}
