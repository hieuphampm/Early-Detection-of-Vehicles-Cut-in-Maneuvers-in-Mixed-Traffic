\section{PHƯƠNG PHÁP NGHIÊN CỨU}
	...
	Mạng nơ-ron hồi quy (RNN) là một kiến trúc mạng chứa các nơ-ron kết nối với nhau, bao gồm các nút đầu vào, nút ẩn và nút đầu ra[cite: 10]. RNN có khả năng xử lý dữ liệu theo chuỗi tuần tự bằng cách nhận đầu vào từ trạng thái ẩn trước đó ($S_{t-1}$) và dữ liệu mới ($x_t$) tại thời điểm hiện tại\cite{Ullah2018ActionRI}. Tuy nhiên, do khối lượng tính toán khổng lồ qua nhiều lớp, RNN truyền thống gặp phải vấn đề triệt tiêu đạo hàm (vanishing gradient), khiến tác động của các đầu vào ban đầu trở nên không đáng kể đối với các chuỗi dài trong tương lai\cite{Ullah2018ActionRI}.
	
	Để giải quyết triệt để vấn đề này, kiến trúc Bộ nhớ ngắn hạn dài hạn (LSTM) được đưa vào sử dụng\cite{Ullah2018ActionRI}. Ý tưởng cốt lõi của kiến trúc LSTM là một ô nhớ kết hợp với các cổng điều khiển phi tuyến: cổng vào, cổng ra và cổng quên\cite{Ullah2018ActionRI}. Cấu trúc đặc biệt này cho phép LSTM duy trì trạng thái của nó qua thời gian và điều tiết chính xác luồng thông tin nào được đưa vào hay đi ra khỏi ô nhớ\cite{Ullah2018ActionRI}. 
	
	Trong bối cảnh của hệ thống đề xuất, mạng CNN (YOLO26n) có nhiệm vụ tìm kiếm các mẫu ẩn trong từng khung hình tĩnh\cite{Ullah2018ActionRI}. Sau đó, LSTM sẽ tiếp nhận chuỗi đặc trưng này để học các thay đổi diễn ra theo tuần tự thời gian\cite{Ullah2018ActionRI}. Khả năng ghi nhớ sự phụ thuộc thời gian dài hạn của LSTM là yếu tố quyết định giúp hệ thống hiểu được sự tiến triển của hành vi lái xe, từ đó phân loại chính xác ý định tạt đầu trước khi hành vi đè vạch hoàn toàn xảy ra.
